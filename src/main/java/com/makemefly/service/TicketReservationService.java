...
public class TicketReservationService {
    ...
    public TicketBookingDetails bookFlightTicket(TicketBookingDTO ticketBookingDTO){
        ...
        double businessSeatCost = 0;
        double nonBusinessSeatCost =0;

            businessSeatCost = businessTicketCostPerTicket * ticketBookingDTO.getNoOfBusinessSeatsBooking();
            nonBusinessSeatCost = nonBusinessTicketCostPerTicket * ticketBookingDTO.getNoOfNonBusinessSeatsBooking();
    ...
    public void addPassengers(List<PassengerDTO> passengerDTOS, TicketBookingDetails ticketBooked){
        Iterator<PassengerDTO> passengerDTOIterable = passengerDTOS.listIterator();
        while(passengerDTOIterable.hasNext()){
            PassengerDTO passengerDTO = passengerDTOIterable.next();
    ...
    public TicketBookingDetails getTicketsByTicketId(int ticketBookingId){
        return ticketReservationRepository.findByTicketBookingId(ticketBookingId);
    }
